 ...
 */
public final class AnFakeRunType extends RunType {
    private final PluginDescriptor descriptor;

    public AnFakeRunType(
    ...
    public String getEditRunnerParamsJspFilePath() {
        return descriptor.getPluginResourcesPath("editAnFake.jsp");
    }

    @Override
    public String getViewRunnerParamsJspFilePath() {
        return descriptor.getPluginResourcesPath("viewAnFake.jsp");
    }
